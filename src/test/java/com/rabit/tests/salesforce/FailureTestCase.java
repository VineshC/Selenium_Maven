 ...
 *
 */
public class FailureTestCase extends SuperTestNG {

	@Test()
	public void testFailureTestCase() throws InterruptedException {
		Thread.sleep(2000);
		driver.findElement(By.xpath("//div[@id='username_container']/input")).clear();
	    driver.findElement(By.xpath("//div[@id='username_container']/input")).sendKeys("sample@test.com");
	    Thread.sleep(2000);
	    driver.findElement(By.xpath("//form[@id='login_form']/input")).clear();
	    //driver.findElement(By.xpath("//form[@id='login_form']/input")).sendKeys("Rabit@12345");
	    Thread.sleep(2000);
